 ...
 *     force 'asm:asm-all:3.3.1', 'commons-io:commons-io'
...
public interface ResolutionStrategy {
     ...
     *
     * configurations.all {
     *   resolutionStrategy.force 'asm:asm-all:3.3.1', 'commons-io:commons-io'
     * }
     * </pre>
     *
     ...
     *
     * configurations.all {
     *   resolutionStrategy.forcedModules = ['asm:asm-all:3.3.1', 'commons-io:commons-io']
     * }
     * </pre>
     *
