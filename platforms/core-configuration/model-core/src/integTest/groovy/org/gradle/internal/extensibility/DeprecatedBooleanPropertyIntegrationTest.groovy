...
class DeprecatedBooleanPropertyIntegrationTest extends AbstractIntegrationSpec {
    ...
    def "emits deprecation warning when a decorated class exposes a Boolean is-getter"() {
        ...
        """
        expect:
        executor.expectDocumentedDeprecationWarning("Declaring 'property' as a property using an 'is-' method with a Boolean type on MyExtension has been deprecated. " +
        ...
        executor.expectDocumentedDeprecationWarning("Referencing property 'property' that was declared with an 'is-' method with a Boolean type on extension 'myext' has been deprecated. " +
            "Starting with Gradle 10, this property will no longer be treated like a property. " +
    ...
    def "emits a deprecation warning when a non-decorated class used as a task input exposes a Boolean is-getter"() {
        ...
        """
        expect:
        executor.expectDocumentedDeprecationWarning("Declaring 'property' as a property using an 'is-' method with a Boolean type on MyValue has been deprecated. " +
            "Starting with Gradle 10, this property will no longer be treated like a property. " +
            "The combination of method name and return type is not consistent with Java Bean property rules. " +
