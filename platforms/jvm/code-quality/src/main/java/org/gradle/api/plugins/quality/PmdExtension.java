...
public abstract class PmdExtension extends CodeQualityExtension {
    ...
    /**
     * The built-in rule sets to be used. See the <a href="https://docs.pmd-code.org/latest/pmd_rules_java.html">official list</a> of built-in rule sets.
     *
     ...
     *
     * See the official documentation for the <a href="https://docs.pmd-code.org/latest/pmd_userdocs_configuring_rules.html">list of priorities</a>.
     *
     * <pre>
     ...
     *
     * See the <a href="https://docs.pmd-code.org/latest/pmd_userdocs_making_rulesets.html">official documentation</a> for how to author a rule set.
     *
     * <pre>
    ...
    /**
     * The custom rule set files to be used. See the <a href="https://docs.pmd-code.org/latest/pmd_userdocs_making_rulesets.html">official documentation</a> for how to author a rule set file.
     *
     * <pre>
     ...
     *
     * This is only supported for PMD 6.0.0 or better. See <a href="https://docs.pmd-code.org/latest/pmd_userdocs_incremental_analysis.html">official documentation</a> for more details.
     *
     * @since 5.6
     */
