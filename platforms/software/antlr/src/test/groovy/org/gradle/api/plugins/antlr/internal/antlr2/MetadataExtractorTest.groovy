...
class MetadataExtractorTest extends Specification {
    ...
    def "parses package information when defined in a separate line"() {
        ...
        atom:   INT
            ;"""
        expect:
        "org.acme" == new MetadataExtractor().getPackageName(new BufferedReader(new StringReader(grammar)))
    }
...
import org.hibernate.hql.internal.ast.ErrorReporter;
        ...
        atom:   INT
            ;"""
        expect:
        "org.hibernate.hql.internal.antlr" == new MetadataExtractor().getPackageName(new BufferedReader(new StringReader(grammar)))
    }
}
