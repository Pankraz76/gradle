 ...
 * Spotless Plugin.
 *
 * @see <a href="https://docs.gradle.org/current/userguide/checkstyle_plugin.html">Spotless plugin reference</a>
 */
public abstract class SpotlessPlugin extends AbstractCodeQualityPlugin<Spotless> {
    ...
    @Override
    protected Class<Spotless> getTaskType() {
        return Spotless.class;
    }
    ...
    protected CodeQualityExtension createExtension() {
        extension = project.getExtensions().create("checkstyle", SpotlessExtension.class, project);
    ...
    @Override
    protected void configureTaskDefaults(Spotless task, final String baseName) {
    ...
    private void configureTaskConventionMapping(Configuration configuration, Spotless task) {
    ...
    private void configureReportsConventionMapping(Spotless task, final String baseName) {
    ...
    private void configureToolchains(Spotless task) {
    ...
    @Override
    protected void configureForSourceSet(final SourceSet sourceSet, Spotless task) {
        task.setDescription("Run Spotless analysis for " + sourceSet.getName() + " classes");
