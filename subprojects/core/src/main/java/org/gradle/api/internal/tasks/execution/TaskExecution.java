...
public class TaskExecution implements MutableUnitOfWork {
    ...
    private DocumentedFailure.Builder summonBuilder(DocumentedFailure.Builder builder, String propertyType, String propertyName, boolean isDestinationDir) {
