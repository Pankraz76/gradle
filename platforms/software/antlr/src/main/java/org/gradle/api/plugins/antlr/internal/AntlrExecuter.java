...
import static org.gradle.api.plugins.antlr.internal.antlr2.MetadataExtracter.extractMetadata;

public class AntlrExecuter implements RequestHandler<AntlrSpec, AntlrResult> { // todo: fix naming Executer -> Executor
