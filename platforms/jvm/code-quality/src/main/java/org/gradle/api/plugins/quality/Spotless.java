 ...
 */
@CacheableTask
public abstract class Spotless extends AbstractCodeQualityTask implements Reporting<PmdReports> {
     ...
     *
     * This is only supported for PMD 6.0.0 or better. See <a href="https://docs.pmd-code.org/pmd-doc-7.17.0/pmd_userdocs_incremental_analysis.html"></a> for more details.
     *
     * @since 5.6
     */
    @Internal
